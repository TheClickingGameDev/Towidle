...
func _ready() -> void:
	...
	$Background/StatisticsLabel.text = str("statistics:\n stone: ",Global.stone,"\npickaxe level: ", Global.pickaxe_level,"/1000\n drill level: ", Global.drill_level,"/1000")
...
func _on_upgrade_pickaxe_button_pressed() -> void:
	if Global.stone >= Global.pickaxe_upgrade_cost && Global.pickaxe_level < 1000 && Global.stone <= Global.stone_limit:
